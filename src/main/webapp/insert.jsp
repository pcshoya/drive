		...
		<form name="frm" onsubmit="return checkValue()">
			<table border="1">
				...
				<tr>
					...
					<td width="500"><input type="text" name="drv_date">
						2023년01월01일 예)20230101</td>
				</tr>
				...
				<tr>
					<td colspan="2" class="td-center"><input type="submit"
						value="주행내역등록"> <input type="reset" value="다시쓰기">
					</td>
				</tr>
			</table>
		</form>
